...
static const uint8_t g_CLUTPalette [COMMON_CLUT_SIZE][4] = {
	...
	{255, 255, 85 , 255}, //  63
	{255, 255, 170, 255}, //  64
	{0  , 0  , 0  , 128}, //  65  黒   以下alpha入り
	{255, 0  , 0  , 128}, //  66  赤
	{0  , 255, 0  , 128}, //  67  緑
	{255, 255, 0  , 128}, //  68  黄
	{0  , 0  , 255, 128}, //  69  青
	{255, 0  , 255, 128}, //  70  マゼンタ
	{0  , 255, 255, 128}, //  71  シアン
	{255, 255, 255, 128}, //  72  白
	{170, 0  , 0  , 128}, //  73
	{0  , 170, 0  , 128}, //  74
	{170, 170, 0  , 128}, //  75
	{0  , 0  , 170, 128}, //  76
...
uint16_t CTsAribCommon::freqKHz2physicalCh (uint32_t freqKHz)
{
	return ((freqKHz - 473143) / 6000) + 13;
}

uint32_t CTsAribCommon::physicalCh2freqKHz (uint16_t ch)
{
	return ((ch - 13) * 6000) + 473143;
}

const uint8_t CTsAribCommon::getCLUTPalette (int idx, int rgba)
{
	return g_CLUTPalette [idx][rgba];
}
