...
typedef enum {
	EN_STREAM_TYPE_MPEG1_VIDEO		= 0x01,
	EN_STREAM_TYPE_MPEG2_VIDEO		= 0x02,
	EN_STREAM_TYPE_MPEG1_AUDIO		= 0x03,
	EN_STREAM_TYPE_MPEG2_AUDIO		= 0x04,
	EN_STREAM_TYPE_SECTION			= 0x05,
	EN_STREAM_TYPE_SUBTITLE			= 0x06,
	EN_STREAM_TYPE_MHEG				= 0x07,
	EN_STREAM_TYPE_DATA_CAROUSEL	= 0x0D,
	EN_STREAM_TYPE_MPEG2_AAC		= 0x0F,
	EN_STREAM_TYPE_MPEG4_VIDEO		= 0x10,
	EN_STREAM_TYPE_MPEG4_AUDIO		= 0x11,
	EN_STREAM_TYPE_MPEG4_AVC		= 0x1B,
	EN_STREAM_TYPE_MPEG4_HEVC		= 0x24,
} EN_STREAM_TYPE;
...
public:
	...
	static uint16_t freqKHz2physicalCh (uint32_t freqKHz);
	static uint32_t physicalCh2freqKHz (uint16_t ch);
